...
[![MCP Tools](https://img.shields.io/badge/MCP%20tools-54-blue.svg)](#connecting-to-ide--llm-via-mcp)
...
The project includes an MCP server with 54 tools for Cursor / Claude Desktop / VS Code / JetBrains.
