...
Проверяет стабильность контракта 56 MCP tools через pytest-snapshot.
Любое изменение в:
- количестве tools
- именах tools
- описаниях tools
...
def tool_definitions() -> list[dict]:
    """Получить определения всех 56 MCP tools для snapshot тестов."""
...
class TestToolDefinitionsSnapshot:
    ...
    def test_tool_names_snapshot(self, snapshot, tool_definitions: list[dict]) -> None:
        """Snapshot имён всех 56 tools (отсортированных)."""
