...
def make_block_header_32(doc_size: int, current_block_size: int = 512,
...
def make_block_header_64(doc_size: int, current_block_size: int = 65536,
                         next_offset: int = END_MARKER_64) -> bytes:
...
def make_block_32(data: bytes, next_offset: int = END_MARKER,
...
def make_block_64(data: bytes, next_offset: int = END_MARKER_64,
