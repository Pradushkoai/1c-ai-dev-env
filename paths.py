#!/usr/bin/env python3
"""
paths.py — Legacy-обёртка над путями проекта.

⚠️  DEPRECATED: используйте src.services.path_manager.PathManager.
    Этот файл сохранён только для обратной совместимости со старыми
    скриптами. Не используйте его в новом коде.
...
warnings.warn(
    "paths.py устарел. Используйте src.services.path_manager.PathManager.",
    DeprecationWarning,
    stacklevel=2,
)
