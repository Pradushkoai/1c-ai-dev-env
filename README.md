...
- 🔲 **v3.14.0** (план): Векторный поиск через fastembed + qdrant
- 🔲 **v3.15.0** (план): Web UI для просмотра API-справочников

---

## Протокол решения задач 1С (5 ролей)
...
| **C. Быстрый** | Опечатка, переименование, версия | 👨‍💻 → ✅ |

📖 **Полная спецификация:** [docs/TASK_PROTOCOL.md](docs/TASK_PROTOCOL.md) — чек-листы для каждой роли, артефакты, anti-patterns, примеры.
