...
def _load_template(template_name: str) -> str:
    ...
    # Этап 1.2, Группа 2: после переноса из scripts/ в src/services/,
    # корень проекта = parent.parent.parent (было parent.parent)
    candidates = [
...
def _fill_template(template: str, replacements: dict[str, Any]) -> str:
...
def generate_processing(name: str, synonym: str, output_dir: str, description: str = "", author: str = "") -> dict[str, Any]:
    ...
    Returns:
        dict[str, Any]: {files: [{path, type, size}], stats: {...}}
    """
...
# CLI вынесен в scripts/code_generator.py (Этап 1.2, Группа 2)
